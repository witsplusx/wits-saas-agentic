...
if not index_loaded:
    ...
    # load data
    lyft_docs = pdf_loader.load_data("./cpnt-check/llamaindex/sty04_rag/data/lyft_2021.pdf")
    uber_docs = SmartPDFLoader.load_data("./cpnt-check/llamaindex/sty04_rag/data/uber_2021.pdf")    
